...
* **v2.0 (Simulação):** Investigar a "causa" da instabilidade em altas temperaturas, modelando a Pressão de Vapor (Equilíbrio Líquido-Vapor) e, eventualmente, utilizando simulações de Dinâmica Molecular (MD) para entender as interações em nível atômico, comparando com os dados obtidos.
